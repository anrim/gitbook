...
Generator.prototype.finish = function() {
    ...
    .then(function() {
        ...
        if (that.options.ebook && 'options' in that.options.ebook) {
          _.extend(_options, that.options.ebook.options);
        }

        var command = (that.options.ebook) ? [that.options.ebook.command || "xvfb-run"] : ["ebook-convert"];
